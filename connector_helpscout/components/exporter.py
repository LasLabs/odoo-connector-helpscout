...
class HelpScoutExporterBase(AbstractComponent):

    _name = 'helpscout.exporter.base'
    _inherit = ['base.exporter', 'base.helpscout.connector']
    _usage = 'record.exporter'

    def __init__(self, working_context):
        super(HelpScoutExporterBase, self).__init__(working_context)
        self.binding = None
    ...
    def run(self, binding, *args, **kwargs):
        ...
        Args:
            binding (HelpScoutBinding): Binding record to export.
        """
...
class HelpScoutExporter(AbstractComponent):
    """A common flow for all HelpScout exports."""

    _name = 'helpscout.exporter'
    _inherit = 'helpscout.exporter.base'

    def __init__(self, working_context):
        super(HelpScoutExporter, self).__init__(working_context)
        self.binding = None
    ...
    def _export_dependency(self, relation, binding_model,
                           ...
                           binding_field='helpscout_bind_ids',
        ...
        if wrap and hasattr(relation, binding_field):
            ...
            # helpscout.product.product and we are exporting it, but we need to
    ...
    def _run(self, fields=None):
        ...
        return _('Record exported with ID %s on HelpScout.') % self.external_id
